...
update_content_to_memory_from_file -instance_index 0 -mem_file_path "test.hex" -mem_file_type hex
  
# Read memory content and save back to a hex memory file
save_content_from_memory_to_file -instance_index 0 -mem_file_path "test.hex" -mem_file_type hex
